...
namespace {
    ...
    static bool MaterialHandleEquals(const CE::Scripting::MaterialHandle &self,
                                     const CE::Scripting::MaterialHandle &other) {
        return self.handle == other.handle;
    }
...
namespace CE::Scripting {
    namespace {
        ...
        Camera3DDesc FromCamera(const Renderer::Camera3D &value) {
            return {FromVec3(value.position),
    ...
    bool Runtime::Register3DBindings() {
        ...
        result = mScriptEngine->RegisterObjectMethod("MaterialHandle", "bool opEquals(const MaterialHandle &in) const",
                                                     asFUNCTION(MaterialHandleEquals), asCALL_CDECL_OBJFIRST);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectMethod("MaterialHandle", "bool opEquals(int64) const",
                                                     asFUNCTION(MaterialHandleEqualsInt), asCALL_CDECL_OBJFIRST);
        if (result < 0) {
            return false;
        }

        mScriptEngine->RegisterObjectType("MeshHandle", sizeof(MeshHandle),
        ...
        result = mScriptEngine->RegisterObjectMethod("MeshHandle", "bool opEquals(const MeshHandle &in) const",
                                                     asFUNCTION(MeshHandleEquals), asCALL_CDECL_OBJFIRST);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectMethod("MeshHandle", "bool opEquals(int64) const",
                                                     asFUNCTION(MeshHandleEqualsInt), asCALL_CDECL_OBJFIRST);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterEnumValue("CameraProjection", "Perspective",
                                                  static_cast<int>(Renderer::Camera3D::ProjectionMode::Perspective));
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterEnumValue("CameraProjection", "Orthographic",
                                                  static_cast<int>(Renderer::Camera3D::ProjectionMode::Orthographic));
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectType("Vec3", sizeof(Vec3Desc),
                                                   asOBJ_VALUE | asOBJ_POD | asGetTypeTraits<Vec3Desc>());
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectBehaviour("Vec3", asBEHAVE_CONSTRUCT, "void f()",
                                                        asFUNCTION(ConstructVec3), asCALL_CDECL_OBJLAST);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectBehaviour("Vec3", asBEHAVE_CONSTRUCT, "void f(float x, float y, float z)",
                                                        asFUNCTION(ConstructVec3XYZ), asCALL_CDECL_OBJLAST);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterObjectType("Transform3D", sizeof(Transform3DDesc),
                                                   asOBJ_VALUE | asOBJ_POD | asGetTypeTraits<Transform3DDesc>());
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectBehaviour("Transform3D", asBEHAVE_CONSTRUCT, "void f()",
                                                        asFUNCTION(ConstructTransform3D), asCALL_CDECL_OBJLAST);
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterObjectProperty("Transform3D", "Vec3 position", asOFFSET(Transform3DDesc, position));
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterObjectProperty("Transform3D", "Vec3 rotation", asOFFSET(Transform3DDesc, rotation));
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterObjectType("Camera3D", sizeof(Camera3DDesc),
                                                   asOBJ_VALUE | asOBJ_POD | asGetTypeTraits<Camera3DDesc>());
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectBehaviour("Camera3D", asBEHAVE_CONSTRUCT, "void f()",
                                                        asFUNCTION(ConstructCamera3D), asCALL_CDECL_OBJLAST);
        if (result < 0) {
            return false;
        }
        ...
        result =
            mScriptEngine->RegisterObjectProperty("Camera3D", "float orthoSize", asOFFSET(Camera3DDesc, orthoSize));
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectProperty("Camera3D", "float aspectOverride",
                                                       asOFFSET(Camera3DDesc, aspectOverride));
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterObjectProperty("Camera3D", "CameraProjection projection",
                                                       asOFFSET(Camera3DDesc, projection));
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectType("Material", sizeof(MaterialDesc),
                                                   asOBJ_VALUE | asOBJ_POD | asGetTypeTraits<MaterialDesc>());
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectBehaviour("Material", asBEHAVE_CONSTRUCT, "void f()",
                                                        asFUNCTION(ConstructMaterial), asCALL_CDECL_OBJLAST);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterObjectProperty("Material", "CE::Graphics::Colour tint",
                                                       asOFFSET(MaterialDesc, tint));
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterObjectProperty("Material", "float roughness", asOFFSET(MaterialDesc, roughness));
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction("void SetCamera3D(const Camera3D &in camera)",
                                                       asMETHOD(Runtime, SetCamera3D), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void GetCamera3D(Camera3D& out camera)",
                                                       asMETHOD(Runtime, GetCamera3D), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction(
            "void SetSunEnabled(bool enabled)", asMETHOD(Runtime, SetSunEnabled), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterGlobalFunction("void SetSunDirection(const Vec3 &in direction)",
                                                  asMETHOD(Runtime, SetSunDirection), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterGlobalFunction("void SetSunPosition(const Vec3 &in position)",
                                                  asMETHOD(Runtime, SetSunPosition), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void SetSunTint(const Vec3 &in colour)",
                                                       asMETHOD(Runtime, SetSunTint), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterGlobalFunction("void SetSunIntensity(float intensity)",
                                                  asMETHOD(Runtime, SetSunIntensity), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result =
            mScriptEngine->RegisterGlobalFunction("void SetAmbientLight(const Vec3 &in colour, float intensity)",
                                                  asMETHOD(Runtime, SetAmbientLight), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction(
            "void LoadSkyBox(const string &in name, const string &in frontPath, const string &in backPath, const "
            "string "
            "&in leftPath, const string &in rightPath, const string &in topPath, const string &in bottomPath)",
            asMETHOD(Runtime, LoadSkyBox), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void SetSkyBox(const string &in name)",
                                                       asMETHOD(Runtime, SetSkyBox), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction(
            "void LoadMaterial(const string &in name, MaterialHandle& out handle)", asMETHOD(Runtime, LoadMaterial),
            asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void ClearSkyBox()", asMETHOD(Runtime, ClearSkyBox),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void UnloadSkyBox(const string &in name)",
                                                       asMETHOD(Runtime, UnloadSkyBox), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction(
            "void CreateMaterialHandle(const Material &in material, const string &in textureName, MaterialHandle &out "
            "materialHandle)",
            asMETHODPR(Runtime, CreateMaterialHandle, (const MaterialDesc &, const std::string &, MaterialHandle &),
                       void),
            asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHODPR(Runtime, DestroyMaterialHandle, (const MaterialHandle &), void), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHODPR(Runtime, SetMaterialRoughness, (const MaterialHandle &, float), bool), asCALL_THISCALL_ASGLOBAL,
            this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHODPR(Runtime, SetMaterialMetallic, (const MaterialHandle &, float), bool), asCALL_THISCALL_ASGLOBAL,
            this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("bool HasMaterial(const MaterialHandle &in handle)",
                                                       asMETHOD(Runtime, HasMaterial), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("int DebugLoadedMaterialsCount()",
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, CreateMeshHandle), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, ChangeMesh), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("void DestroyMesh(const MeshHandle &in handle)",
                                                       asMETHOD(Runtime, DestroyMesh), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("bool HasMesh(const MeshHandle &in handle)",
                                                       asMETHOD(Runtime, HasMesh), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction(
            "void DrawMesh(const MeshHandle &in handle, const Transform3D &in transform, const MaterialHandle &in "
            "materialHandle = MaterialHandle(), bool errorTexture = false)",
            asMETHOD(Runtime, DrawMesh), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
    ...
    void Runtime::LoadSkyBox(const std::string &name, const std::string &frontPath, const std::string &backPath,
                             const std::string &leftPath, const std::string &rightPath, const std::string &topPath,
                             const std::string &bottomPath) {
        mSkyboxManager.Load(frontPath, backPath, leftPath, rightPath, topPath, bottomPath, name);
    }
    ...
    void Runtime::CreateMaterialHandle(const MaterialDesc &material, const std::string &textureName,
    ...
    void Runtime::DrawMesh(const MeshHandle &handle, const Transform3DDesc &transform,
                           const MaterialHandle &materialHandle, bool errorTexture) {
