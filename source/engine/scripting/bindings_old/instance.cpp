...
namespace CE::Scripting {
    bool Runtime::RegisterInstanceBindings() {
        ...
        result = mScriptEngine->RegisterGlobalFunction("void Exit()", asMETHOD(Runtime, ExitInstance),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("float GetDeltaTime()", asMETHOD(Runtime, GetDeltaTime),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("float GetFrameTime()", asMETHOD(Runtime, GetFrameTime),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("int GetFPS()", asMETHOD(Runtime, GetFPS),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("int GetInstanceID()", asMETHOD(Runtime, GetInstanceID),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction("void ReloadSettings()", asMETHOD(Runtime, ReloadSettings),
                                                       asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, GetSettingInt), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, GetSettingFloat), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, GetSettingBool), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, GetSettingString), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, SetSettingInt), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, SetSettingFloat), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, SetSettingBool), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, SetSettingString), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction("void Set(const string &in state)",
                                                       asMETHOD(Runtime, SetGameState), asCALL_THISCALL_ASGLOBAL, this);
        if (result < 0) {
            return false;
        }

        result = mScriptEngine->RegisterGlobalFunction("string Get()", asMETHOD(Runtime, GetGameState),
                                                       asCALL_THISCALL_ASGLOBAL, this);
    ...
    bool Runtime::RegisterCallbackBindings() {
        ...
        int result =
            mScriptEngine->RegisterFuncdef("void StateCallback(const string &in state, const string &in eventName)");
        if (result < 0) {
            return false;
        }
        ...
        result = mScriptEngine->RegisterGlobalFunction(
            ...
            asMETHOD(Runtime, RegisterStateCallback), asCALL_THISCALL_ASGLOBAL, this);
        mScriptEngine->SetDefaultNamespace("");
        return result >= 0;
    }
    ...
    int Runtime::RegisterStateCallback(const std::string& state, const std::string& eventName,
        ...
        const int id = mInstance.GetEventBus().Subscribe(
            state, eventName, [this, callback](std::string_view emittedState, std::string_view emittedEventName) {
                if (!InvokeStateCallback(callback, std::string(emittedState), std::string(emittedEventName))) {
                    mInstance.Exit();
                }
            });

        mStateCallbacks.push_back({state, eventName, id, callback});
