...
namespace CE::Scripting {
    ...
    void Runtime::DrawTexture(const TextureHandle& texture, int x, int y, bool flipX, bool flipY, float tileX, float tileY) {
        ...
        if (flipX && flipY) {
            flip = static_cast<CE::Renderer::TextureFlip>(
                static_cast<uint8_t>(CE::Renderer::TextureFlip::Horizontal) |
    ...
    bool Runtime::RegisterAssetTextureBindings() {
        ...
        CE_REGISTER_GLOBAL("void DrawTexture(const CE::Texture &in texture, int x, int y, bool flipX = false, bool flipY = false, float tileX = 1.0f, float tileY = 1.0f)", DrawTexture);
        CE_REGISTER_GLOBAL("void DrawTextureEx(const CE::Texture &in texture, int x, int y, const CE::Graphics::Colour &in colour, bool flipX = false, bool flipY = false, float tileX = 1.0f, float tileY = 1.0f)", DrawTextureEx);
        CE_REGISTER_GLOBAL("void DrawTextureRot(const CE::Texture &in texture, int x, int y, float rotation, bool flipX = false, bool flipY = false, float tileX = 1.0f, float tileY = 1.0f)", DrawTextureRot);
        CE_REGISTER_GLOBAL("void DrawTextureRotEx(const CE::Texture &in texture, int x, int y, float rotation, const CE::Graphics::Colour &in colour, bool flipX = false, bool flipY = false, float tileX = 1.0f, float tileY = 1.0f)", DrawTextureRotEx);
        CE_REGISTER_GLOBAL("void DrawTexturePro(const CE::Texture &in texture, int x, int y, int w, int h, float rotation, const CE::Graphics::Colour &in colour, bool flipX = false, bool flipY = false, float tileX = 1.0f, float tileY = 1.0f)", DrawTexturePro);
