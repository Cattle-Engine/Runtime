...
namespace CE::Scripting {
    bool Runtime::RegisterAssetPrimitiveBindings() {
        ...
        CE_REGISTER_GLOBAL("void DrawRectangle(float x, float y, float w, float h, const CE::Graphics::Colour &in colour, float rotation = 0.0f)", DrawRectangle);
        CE_REGISTER_GLOBAL("void DrawCircle(float x, float y, float radius, int segments, const CE::Graphics::Colour &in colour)", DrawCircle);
        CE_REGISTER_GLOBAL("void DrawLine(float x1, float y1, float x2, float y2, float thickness, const CE::Graphics::Colour &in colour)", DrawLine);
        CE_REGISTER_GLOBAL("void DrawTriangle(float x0, float y0, float x1, float y1, float x2, float y2, const CE::Graphics::Colour &in colour, float rotation = 0.0f)", DrawTriangle);
        CE_REGISTER_GLOBAL("void DrawRectangleLines(float x, float y, float w, float h, float thickness, const CE::Graphics::Colour &in colour)", DrawRectangleLines);
        CE_REGISTER_GLOBAL("void DrawCircleLines(float x, float y, float radius, int segments, float thickness, const CE::Graphics::Colour &in colour)", DrawCircleLines);
        ...
        CE_REGISTER_GLOBAL("void DrawTextCol(const string &in text, int x, int y, float size, const CE::Graphics::Colour &in colour)", DrawTextCol);
        CE_REGISTER_GLOBAL("void DrawTextEx(const string &in text, const string &in name, int x, int y, float size, const CE::Graphics::Colour &in colour)", DrawTextEx);
