...
namespace CE::Scripting {
    ...
    bool Runtime::RegisterAssetMeshBindings() {
        ...
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCube(float width, float height, float depth)", asFUNCTION(CreateCubeMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCube(float width, float height, float depth, const Colour &in colour)", asFUNCTION(CreateCubeMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreatePlane(float width, float depth)", asFUNCTION(CreatePlaneMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreatePlane(float width, float depth, const Colour &in colour)", asFUNCTION(CreatePlaneMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateSphere(float radius, int segments, int rings)", asFUNCTION(CreateSphereMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateSphere(float radius, int segments, int rings, const Colour &in colour)", asFUNCTION(CreateSphereMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCylinder(float radius, float height, int segments)", asFUNCTION(CreateCylinderMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCylinder(float radius, float height, int segments, const Colour &in colour)", asFUNCTION(CreateCylinderMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCone(float radius, float height, int segments)", asFUNCTION(CreateConeMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCone(float radius, float height, int segments, const Colour &in colour)", asFUNCTION(CreateConeMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateTorus(float radius, float tubeRadius, int segments, int tubeSegments)", asFUNCTION(CreateTorusMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateTorus(float radius, float tubeRadius, int segments, int tubeSegments, const Colour &in colour)", asFUNCTION(CreateTorusMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCapsule(float radius, float height, int segments)", asFUNCTION(CreateCapsuleMesh), asCALL_CDECL) < 0) {
            return false;
        }
        if (mScriptEngine->RegisterGlobalFunction("MeshData@ CreateCapsule(float radius, float height, int segments, const Colour &in colour)", asFUNCTION(CreateCapsuleMeshCol), asCALL_CDECL) < 0) {
            return false;
        }
