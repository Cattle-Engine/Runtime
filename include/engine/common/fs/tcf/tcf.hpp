    ...
    class TCFArchive {
        ...
        private:
            ...
            /*
                ...
                Chunk IDs are per file, and go up by one per chunk. Chunks a read until a chunk ID is the same as the chunk count in the file info.
                If a chunk with the next ID (or there's no 0 chunk) you will get an error.
            ...
            */
            struct FileInfo {
                ...
                uint64_t chunk_block_offset; // this is the absolute archive offset of the first byte of the first chunk header for this file.
