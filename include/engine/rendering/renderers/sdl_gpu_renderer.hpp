...
namespace CE::Renderer::SDL_GPU_Renderer {
    ...
    struct SDL_GPU_Renderer_Shader {
        enum class PipelineMode { Mode2D, Mode3D };
...
#pragma pack(pop)
    ...
    class SDL_GPU_Renderer : public Renderer::IRenderer {
      public:
        ...
        void DrawMesh(GPUMesh* mesh, Material& material, const Transform3D& transform, [[maybe_unused]] bool error_tex) override;
        void DrawMeshMat4(GPUMesh* mesh, Material& material, const glm::mat4& transform, [[maybe_unused]] bool error_tex) override;
      ...
      private:
        ...
        SDL_GPUGraphicsPipeline* Create3DGraphicsPipeline(SDL_Window* window, SDL_GPUShader* vertexShader,
                                                          SDL_GPUShader* fragmentShader, bool isSkybox = false,
                                                          bool isTransparent = false) const;
